 ...
 void OnGUI() 
	{
		...
		if (GUI.Button(new Rect(480, 60, 70, 30),"Attack02")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Attack02");
		}

		if (GUI.Button(new Rect(555, 60, 70, 30),"Attack03")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Attack03");
		}


		if (GUI.Button(new Rect(630, 60, 70, 30),"Block")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Block");
		}

		if (GUI.Button(new Rect(705, 60, 70, 30),"BlockAttack")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_BlockAttack");
		}

		if (GUI.Button(new Rect(780, 60, 70, 30),"Combo1_1")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Combo1_1");
		}

		if (GUI.Button(new Rect(30, 100, 70, 30),"Combo1_2")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Combo1_2");
		}

		if (GUI.Button(new Rect(105, 100, 70, 30),"Combo1_3")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Combo1_3");
		}

		if (GUI.Button(new Rect(180, 100, 70, 30),"Kick")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Kick");
		}

		if (GUI.Button(new Rect(255, 100, 70, 30),"Skill")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Skill");
		}


		if (GUI.Button(new Rect(330, 100, 70, 30),"Spell")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Spell");
		}


		if (GUI.Button(new Rect(405, 100, 70, 30),"M_Avoid")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_M_Avoid");
		}

		if (GUI.Button(new Rect(480, 100, 70, 30),"L_Avoid")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_L_Avoid");
		}

		if (GUI.Button(new Rect(555, 100, 70, 30),"R_Avoid")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_R_Avoid");
		}

		if (GUI.Button(new Rect(630, 100, 70, 30),"Buff")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Buff");
		}

		if (GUI.Button(new Rect(705, 100, 70, 30),"Run01")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
			frog.GetComponent<Animation>().CrossFade("BG_Run01");
		}

		if (GUI.Button(new Rect(780, 100, 70, 30),"RunAttack")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
...
//		}
		...
		if (GUI.Button(new Rect(825, 160, 30, 30),"2")){
			...
			GUI02.SetActive(true);
				...
				if (GUI.Button (new Rect (20, 580, 140, 40), "Ver 2.8")) {
						frog.GetComponent<Animation>().wrapMode = WrapMode.Loop;
						frog.GetComponent<Animation>().CrossFade ("BG_Idle");
				}
